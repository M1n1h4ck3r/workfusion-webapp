  ...
  theme: {
    extend: {
      colors: {
        ...
        text: {
          primary: '#FFFFFF',
          secondary: '#C0C0C0', /* Improved contrast from #A0A0A0 */
        },
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'linear-gradient(135deg, #4ADE80 0%, #FCD34D 25%, #FB923C 50%, #4ADE80 75%, #FCD34D 100%)',
      },
      animation: {
      ...
      fontFamily: {
        ...
        'heading': ['Inter', 'Montserrat', 'Space Grotesk', 'sans-serif'],
